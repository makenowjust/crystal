...
module Crystal
  class Parser < Lexer
    ...
    def parse_atomic_without_location
      ...
      when :PERSISTENT
        node = new_node_check_type_declaration Global
      when :"$~", :"$?"
        location = @token.location
    ...
    def parse_call_args_space_consumed(check_plus_and_minus = true, allow_curly = false)
      ...
      when :CHAR, :STRING, :DELIMITER_START, :STRING_ARRAY_START, :SYMBOL_ARRAY_START, :NUMBER, :IDENT, :SYMBOL, :INSTANCE_VAR, :CLASS_VAR, :CONST, :GLOBAL, :PERSISTENT, :"$~", :"$?", :GLOBAL_MATCH_DATA_INDEX, :REGEX, :"(", :"!", :"[", :"[]", :"+", :"-", :"~", :"&", :"->", :"{{", :__LINE__, :__FILE__, :__DIR__, :UNDERSCORE
        # Nothing
      when :"*", :"**"
